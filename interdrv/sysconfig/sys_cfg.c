...
#define SENSOR_NAME_ISR2006 "isr2006"
#define MIPI_AD "mipi_ad"

static void *g_reg_crg_base = 0;
static void *g_reg_sys_base = 0;
static void *g_reg_misc_base = 0;
static void *g_reg_iocfg_base = 0;  // 0x10260000
static void *g_reg_iocfg2_base = 0; // 0x179F0000
static void *g_reg_iocfg3_base = 0; // 0x0EFF0000
...
static unsigned int parse_sensor_clock(const char *name, unsigned int name_len)
{
    ...
    else if (strncmp(SENSOR_NAME_ISR2006, name, len) == 0)
    {
        clock = 0xA001; // 27MHZ
    }
