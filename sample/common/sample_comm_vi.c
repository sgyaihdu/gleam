...
static hi_u32 g_first_time_run = 0;
...
static ext_data_type_t g_mipi_ext_data_type_isr2006_12bit_1936_1280_nowdr_attr = {
    .devno = 0,
    .num = MIPI_NUM,
    .ext_data_bit_width = {12, 12, 12},
    .ext_data_type = {0x2c, 0x2c, 0x2c}};

static ext_data_type_t g_mipi_ext_data_type_isr2006_14bit_1920_1080_nowdr_attr = {
    .devno = 0,
    .num = MIPI_NUM,
    .ext_data_bit_width = {12, 12, 12},
    .ext_data_type = {0x37, 0x2c, 0x2c}};
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_isr2006_12bit_1936_1280_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
    .img_rect = {0, 0, ISR2006_WIDTH, ISR2006_HEIGHT},
    .mipi_attr = {
#if ISR2006_10BIT_ENABLE
                  DATA_TYPE_RAW_10BIT,
#else
                  DATA_TYPE_RAW_12BIT,
#endif
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_isr2006_10bit_1936_1280_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
    .img_rect = {0, 0, ISR2006_WIDTH, ISR2006_HEIGHT},
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_isr2006_12bit_968_640_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
    .img_rect = {0, 0, ISR2006_968P_WIDTH, ISR2006_968P_HEIGHT},
    .mipi_attr = {
                  DATA_TYPE_RAW_12BIT,
                  HI_MIPI_WDR_MODE_NONE,
                  {0, 1, 2, 3, -1, -1, -1,-1}},
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_isr2006_14bit_1920_1080_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
    .img_rect = {0, 0, ISR2006_1080P_WIDTH, ISR2006_1080P_HEIGHT},
    .mipi_attr = {
                  DATA_TYPE_RAW_14BIT,
                  HI_MIPI_WDR_MODE_NONE,
                  {0, 1, -1, -1, -1, -1, -1, -1}},
...
static hi_void sample_comm_vi_get_mipi_attr_part1(sample_sns_type sns_type, combo_dev_attr_t *combo_attr,
    hi_u32 *ob_height)
{
    switch (sns_type) {
...
static hi_void sample_comm_vi_get_mipi_attr(sample_sns_type sns_type, combo_dev_attr_t *combo_attr)
{
    ...
    switch (sns_type) {
        ...
        case SONY_IMX515_MIPI_8M_30FPS_12BIT:
            ...
            break;
        case ISR2006_MIPI_1936_1280_30FPS_12BIT:
        case ISR2006_MIPI_1936_1280_25FPS_12BIT:
            ob_height = OB_HEIGHT_ISR2006; // ob区域的高度，根据sensor手册来选择
            (td_void) memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_4lane_chn0_sensor_isr2006_12bit_1936_1280_nowdr_attr, sizeof(combo_dev_attr_t));
            sample_print("sample_comm_vi_get_mipi_attr  isr2006 success\n");
            break;

        
        case ISR2006_MIPI_968_640_25FPS_12BIT:
            ob_height = OB_HEIGHT_ISR2006; // ob区域的高度，根据sensor手册来选择
            (td_void) memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_4lane_chn0_sensor_isr2006_12bit_968_640_nowdr_attr, sizeof(combo_dev_attr_t));
            sample_print("sample_comm_vi_get_mipi_attr  isr2006 success\n");
            break;
            
        case ISR2006_MIPI_1920_1080_30FPS_14BIT:
            ob_height = OB_HEIGHT_ISR2006; // ob区域的高度，根据sensor手册来选择
            (td_void) memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_4lane_chn0_sensor_isr2006_14bit_1920_1080_nowdr_attr, sizeof(combo_dev_attr_t));
            sample_print("sample_comm_vi_get_mipi_attr  isr2006 14bit success\n");
            break;
    ...
    switch (sns_type) {
        ...
        case ISR2006_MIPI_968_640_25FPS_12BIT:
            (td_void) memcpy_s(ext_data_attr, sizeof(ext_data_type_t),
                           &g_mipi_ext_data_type_isr2006_12bit_1936_1280_nowdr_attr, sizeof(ext_data_type_t));
                           printf("mipi_ext_type = %#x\n",g_mipi_ext_data_type_isr2006_12bit_1936_1280_nowdr_attr.ext_data_type[0]);
            break;
        case ISR2006_MIPI_1920_1080_30FPS_14BIT:
            (td_void) memcpy_s(ext_data_attr, sizeof(ext_data_type_t),
                           &g_mipi_ext_data_type_isr2006_14bit_1920_1080_nowdr_attr, sizeof(ext_data_type_t));
            break;
        default:
            (hi_void)memcpy_s(ext_data_attr, sizeof(ext_data_type_t),
                &g_mipi_ext_data_type_default_attr, sizeof(ext_data_type_t));
...
static ot_vi_dev_attr g_mipi_raw_isr2006_dev_attr = {
    ...
    /* mask component */
    .component_mask = {0xfff00000, 0x00000000},//12bit
    ...
    /* data seq */
    .data_seq = HI_VI_DATA_SEQ_YVYU, // 只对yuv数据有效

    /* sync param */
    .sync_cfg = { //定义视频设备接收BT.601、DC、BT.656和BT.1120时序的同步信息 使用mipi时不需要考虑
    ...
    /* input size */
    .in_size = {ISR2006_WIDTH, ISR2006_HEIGHT},
...
static ot_vi_dev_attr g_mipi_raw_isr2006_14bit_dev_attr = {
    .intf_mode = HI_VI_INTF_MODE_MIPI,
    ...
    /* mask component */
    .component_mask = {0xfffc0000, 0x00000000},//14bit
    ...
    /* sync param */
    .sync_cfg = { //定义视频设备接收BT.601、DC、BT.656和BT.1120时序的同步信息 不需要考虑
        .vsync = HI_VI_VSYNC_FIELD,
        .vsync_neg = HI_VI_VSYNC_NEG_HIGH,
        .hsync = HI_VI_HSYNC_VALID_SIG,
        .hsync_neg = HI_VI_HSYNC_NEG_HIGH,
    ...
    /* input size */
    .in_size = {ISR2006_1080P_WIDTH, ISR2006_1080P_HEIGHT},

    /* data rate */
    .data_rate = HI_DATA_RATE_X1,
};

static hi_vi_dev_attr g_bt1120_yuv422_dev_attr = {
    .intf_mode = HI_VI_INTF_MODE_BT1120,
    ...
    /* data seq */
    .data_seq = HI_VI_DATA_SEQ_UYVY,//要考虑bt1120的数据格式 

    /* sync param */
    .sync_cfg = {
        .vsync           = HI_VI_VSYNC_PULSE,
        .vsync_neg       = HI_VI_VSYNC_NEG_LOW,
        .hsync           = HI_VI_HSYNC_VALID_SIG,
        .hsync_neg       = HI_VI_HSYNC_NEG_HIGH,
        .vsync_valid     = HI_VI_VSYNC_VALID_SIG,
        .vsync_valid_neg = HI_VI_VSYNC_VALID_NEG_HIGH,
...
static hi_void sample_comm_vi_get_dev_attr_by_intf_mode(hi_vi_intf_mode intf_mode, hi_vi_dev_attr *dev_attr)
{
    switch (intf_mode) {
        ...
        if (SENSOR_TYPE == ISR2006_MIPI_1936_1280_30FPS_12BIT || SENSOR_TYPE == ISR2006_MIPI_1936_1280_25FPS_12BIT || SENSOR_TYPE == ISR2006_MIPI_968_640_25FPS_12BIT)
        {
            (td_void) memcpy_s(dev_attr, sizeof(ot_vi_dev_attr), &g_mipi_raw_isr2006_dev_attr, sizeof(ot_vi_dev_attr));
            sample_print("g_mipi_raw_isr2006_dev_attr success \n");
        
        }else if(SENSOR_TYPE == ISR2006_MIPI_1920_1080_30FPS_14BIT)
        {
            (td_void) memcpy_s(dev_attr, sizeof(ot_vi_dev_attr), &g_mipi_raw_isr2006_14bit_dev_attr, sizeof(ot_vi_dev_attr));
            //(td_void) memcpy_s(dev_attr, sizeof(ot_vi_dev_attr), &g_mipi_raw_isr2006_dev_attr, sizeof(ot_vi_dev_attr));
            sample_print("g_mipi_raw_isr2006_dev_attr_14bit success \n");
        }
        else{
            (hi_void)memcpy_s(dev_attr, sizeof(hi_vi_dev_attr), &g_mipi_raw_dev_attr, sizeof(hi_vi_dev_attr));
        }
        break;
        case HI_VI_INTF_MODE_BT1120:
            (hi_void)memcpy_s(dev_attr, sizeof(hi_vi_dev_attr), &g_bt1120_yuv422_dev_attr, sizeof(hi_vi_dev_attr));
            //printf("bt1120 data_seq = %d\n",dev_attr->data_seq);
            break;
...
hi_void sample_comm_vi_get_size_by_sns_type(sample_sns_type sns_type, hi_size *size)
{
    switch (sns_type) {
        ...
        case ISR2006_MIPI_1936_1280_30FPS_12BIT:
        case ISR2006_MIPI_1936_1280_25FPS_12BIT:
            size->width = ISR2006_WIDTH;
            size->height = ISR2006_HEIGHT;
            break;
        case ISR2006_MIPI_968_640_25FPS_12BIT:
            size->width = ISR2006_968P_WIDTH;
            size->height = ISR2006_968P_HEIGHT;
            break;
        case ISR2006_MIPI_1920_1080_30FPS_14BIT:
            size->width = ISR2006_1080P_WIDTH;
            size->height = ISR2006_1080P_HEIGHT;
            break;
        case SAMPLE_VI_MODE_BT1120_1080P_16BIT:
...
/**
 * Initializes a sample_sns_info structure with the default sensor information
 * based on the specified sensor type.
 *
 * @param sns_type The type of sensor for which default information is needed.
 * @param sns_info A pointer to the sample_sns_info structure to be initialized.
 *
 * This function sets various fields of the sns_info structure, such as sns_type,
 * sns_clk_src, sns_rst_src, and bus_id, to default values. The sns_clk_src and
 * sns_rst_src are initialized to 0, while bus_id is set to 4, which can be
 * modified based on specific board requirements. If the sensor type is
 * GST_412C_SLAVE_THERMO_T3_384_288_30FPS_14BIT, the bus_id is updated to 6.
 */

hi_void sample_comm_vi_get_default_sns_info(sample_sns_type sns_type, sample_sns_info *sns_info)
{
    sns_info->sns_type    = sns_type;
    sns_info->sns_clk_src = 0;//hj:使用sonser0时用0 sonser1时用1 2414：使用1  2414使用时需要修改sysconfig.ko,将sensor2_clk改成sensor1_clk
    sns_info->sns_rst_src = 0;//hj:使用sonser0时用0 sonser1时用1 2414：使用1
    sns_info->bus_id      = 4; /* 对于hj底板 sensor0 使用4 sensor1 使用5 */ /*2414 使用5*/
    printf("sensor bus_id %d\n", sns_info->bus_id);
...
hi_void sample_comm_vi_get_default_dev_info(sample_sns_type sns_type, sample_vi_dev_info *dev_info)
{
    ...
    if (sns_type == GST_412C_SLAVE_THERMO_T3_384_288_30FPS_14BIT ) {
        dev_info->vi_dev = 1;
        intf_mode = HI_VI_INTF_MODE_THERMO;
    }else if(sns_type == SAMPLE_VI_MODE_BT1120_1080P_16BIT)
    {
        dev_info->vi_dev = 1;
        intf_mode = HI_VI_INTF_MODE_BT1120;
    }
    
    sample_comm_vi_get_dev_attr_by_intf_mode(intf_mode, &dev_info->dev_attr);
    ...
    if (sns_type == GST_412C_SLAVE_THERMO_T3_384_288_30FPS_14BIT) {
        dev_info->dev_attr.intf_mode = HI_VI_INTF_MODE_THERMO;
...
static hi_void sample_comm_vi_get_default_bind_info(sample_sns_type sns_type, hi_vi_bind_pipe *bind_pipe)
{
    ...
    for (i = 0; i < bind_pipe->pipe_num; i++) {
        ...
        if(sns_type == SAMPLE_VI_MODE_BT1120_1080P_16BIT)
        {
            bind_pipe->pipe_id[i] = i+3;
        }
...
static hi_void sample_comm_vi_get_default_grp_info(sample_sns_type sns_type, sample_vi_grp_info *grp_info)
{
    ...
    for (i = 0; i < pipe_num; i++) {
        ...
        if(sns_type == SAMPLE_VI_MODE_BT1120_1080P_16BIT)
        {
            grp_info->fusion_grp_attr[0].pipe_id[i] = i+3;
        }
    }
}
                                             ...
                                             sample_vi_pipe_info pipe_info[])
{
    ...
    for (i = 0; i < bind_pipe->pipe_num; i++) {
        ...
        #if VI_CROP_IS_ENANLE
        if(SENSOR0_TYPE == ISR2006_MIPI_1936_1280_30FPS_12BIT || SENSOR0_TYPE == ISR2006_MIPI_1936_1280_25FPS_12BIT){
            pipe_info[i].pipe_attr.size.width = ISR2006_CROP_WIDTH;
            pipe_info[i].pipe_attr.size.height = ISR2006_CROP_HEIGHT;
        }
        #endif
        ...
        if (sns_type == GST_412C_SLAVE_THERMO_T3_384_288_30FPS_14BIT) {
            ...
            pipe_info[i].pipe_attr.pixel_format = HI_PIXEL_FORMAT_RGB_BAYER_14BPP;
        }
        if(sns_type == ISR2006_MIPI_1920_1080_30FPS_14BIT){
            pipe_info[i].pipe_attr.pixel_format = HI_PIXEL_FORMAT_RGB_BAYER_14BPP;
        }
        ...
        if(sns_type == SAMPLE_VI_MODE_BT1120_1080P_16BIT)
        {
            pipe_info[i].pipe_attr.isp_bypass                     = HI_TRUE;
            pipe_info[i].pipe_attr.pixel_format                   = HI_PIXEL_FORMAT_YVU_SEMIPLANAR_422;
            pipe_info[i].pipe_attr.compress_mode                  = HI_COMPRESS_MODE_NONE;
            pipe_info[i].isp_need_run = HI_FALSE;
        }

        if (i == 0 || (i == 3 && sns_type == SAMPLE_VI_MODE_BT1120_1080P_16BIT) ) {
    ...
    #if VI_CROP_IS_ENANLE
        if(SENSOR0_TYPE == ISR2006_MIPI_1936_1280_30FPS_12BIT || SENSOR0_TYPE == ISR2006_MIPI_1936_1280_25FPS_12BIT ){
        pipe_info[i].chn_info[0].chn_attr.size.width = ISR2006_CROP_WIDTH;
        pipe_info[i].chn_info[0].chn_attr.size.height = ISR2006_CROP_HEIGHT;
        }
    #endif
        ...
        pipe_info[i].chn_info[0].chn_attr.compress_mode                  = HI_COMPRESS_MODE_SEG;
        ...
        if(sns_type == SAMPLE_VI_MODE_BT1120_1080P_16BIT)
        {
            pipe_info[i].chn_info[0].chn_attr.pixel_format                   = HI_PIXEL_FORMAT_YVU_SEMIPLANAR_422;
        }
#if ISR2006_IS_MONO
        if(sns_type == ISR2006_MIPI_1936_1280_25FPS_12BIT)
        {
            pipe_info[i].chn_info[0].chn_attr.pixel_format                   = HI_PIXEL_FORMAT_YVU_SEMIPLANAR_422; 
            pipe_info[i].pipe_attr.frame_rate_ctrl.src_frame_rate = -1;
            pipe_info[i].pipe_attr.frame_rate_ctrl.dst_frame_rate = -1;
        ...
        pipe_info[i].pipe_attr.size.width                     = 3840;
        pipe_info[i].pipe_attr.size.height                    = 1080;

        pipe_info[i].chn_info[0].chn_attr.size.width                     = 3840;
        pipe_info[i].chn_info[0].chn_attr.size.height                    = 1080;
        pipe_info[i].chn_info[0].chn_attr.pixel_format                   = HI_PIXEL_FORMAT_YVU_SEMIPLANAR_420; 
#endif
    }
}
...
hi_void sample_comm_vi_get_vi_cfg_by_fmu_mode(sample_sns_type sns_type, hi_fmu_mode fum_mode, sample_vi_cfg *vi_cfg)
{
    ...
    if (fum_mode == HI_FMU_MODE_DIRECT) {
    ...
    } else if (fum_mode == HI_FMU_MODE_WRAP) {
        for (i = 0; i < vi_cfg->bind_pipe.pipe_num; i++) {
            vi_cfg->pipe_info[i].chn_info[0].fmu_mode = fum_mode;
...
static hi_s32 sample_comm_vi_mipi_ctrl_cmd(hi_u32 devno, hi_u32 cmd)
{
    ...
    //printf("sample_comm_vi_mipi_ctrl_cmd = 0x%x,mipi_devno = %d\n",cmd ,devno);
...
static hi_s32 sample_comm_vi_set_mipi_combo_attr(const combo_dev_attr_t *combo_dev_attr)
{
    ...
    //ret = ioctl(fd, HI_MIPI_SET_PHY_SPEED_MODE, PHY_SPEED_GT1500M_BITPERSEC);
...
// static hi_s32 sample_comm_vi_set_mipi_phy_speed_mode(const phy_speed_mode_t *phy_speed_attr)
// {
//     hi_s32 fd;
//     hi_s32 ret;
...
//     ret = ioctl(fd, HI_MIPI_SET_PHY_SPEED_MODE, phy_speed_attr);
...
static hi_s32 sample_comm_vi_start_sensor(const sample_sns_info *sns_info)
{
    hi_s32 ret;
...
static hi_s32 sample_comm_vi_start_mipi_rx(const sample_sns_info *sns_info, const sample_mipi_info *mipi_info)
{
    ...
    if (ret != HI_SUCCESS) {
        ...
        perror("mipi rx set combo attr failed!\n");
        return HI_FAILURE;
    }

    // phy_speed_mode_t phy_speed_t = PHY_SPEED_GT1500M_BITPERSEC;
    // ret = sample_comm_vi_set_mipi_phy_speed_mode(&phy_speed_t);
    // if (ret != HI_SUCCESS) {
    //     sample_print("mipi rx set phy speed mode attr failed!\n");
    //     return HI_FAILURE;
    // }
...
static hi_s32 sample_comm_vi_start_dev(hi_vi_dev vi_dev, const hi_vi_dev_attr *dev_attr)
{
    ...
    // printf("vi enable dev success! vi_dev = %d\n", vi_dev);
...
static hi_s32 sample_comm_vi_start_chn(hi_vi_pipe vi_pipe, const sample_vi_pipe_info *pipe_info)
{
    ...
    for (i = 0; i < chn_num; i++) {
        ...
        ret = hi_mpi_vi_set_chn_fmu_mode(vi_pipe, vi_chn, chn_info[i].fmu_mode);
        if (ret != HI_SUCCESS) {
...
ot_crop_info g_vi_crop_info = 
{
    .enable = TD_TRUE,
    .rect = {
        .x = ISR2006_CROP_X,
        .y = ISR2006_CROP_Y,
        .width = ISR2006_CROP_WIDTH,
        .height = ISR2006_CROP_HEIGHT
    }
};


td_s32 sample_comm_mpi_vi_set_pipe_pre_crop(const ot_vi_pipe vi_pipe,const ot_crop_info *crop_info)
{

    td_s32 ret;


    printf("设置裁剪区域:enable=%d, X=%d, Y=%d, 宽度=%u, 高度=%u\n",crop_info->enable,
           crop_info->rect.x, crop_info->rect.y, crop_info->rect.width, crop_info->rect.height);

        ret = hi_mpi_vi_set_pipe_pre_crop(vi_pipe,crop_info);
        if (ret != TD_SUCCESS)
        {
            sample_print("vi  pipe(%d) crop failed! errno:%x\n", vi_pipe, ret);
            goto exit;
        }
    ...
    hi_bool is_master_pipe)
{
    ...
    /*
    //打印pipe_info->pipe_attr
    printf("pipe_attr:");
    printf("pipe_bypass_mode = %d\nisp_bypass=%d\nsize = %d*%d\npixel_format =%d\ncompress_mode=%d\n"\
    ,pipe_info->pipe_attr.pipe_bypass_mode,pipe_info->pipe_attr.isp_bypass,pipe_info->pipe_attr.size.width,pipe_info->pipe_attr.size.height,\
    pipe_info->pipe_attr.pixel_format,pipe_info->pipe_attr.compress_mode);
    */
...
#if VI_CROP_IS_ENANLE
    ret = sample_comm_mpi_vi_set_pipe_pre_crop(vi_pipe,&g_vi_crop_info);
    if (ret != TD_SUCCESS)
    {
        sample_print("start crop failed!\n");
        goto start_pipe_failed;
    }
#endif
...
void sample_json_set_attr(hi_vi_pipe vi_pipe)
{

    hi_s32 ret;
    const char* filename = "isp_attr.json";
    ...
    ret = set_isp_exposure_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_exposure_attr_byjson(json, vi_pipe);

    ret = set_isp_wdr_smart_fastface_exposure_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_wdr_smart_fastface_exposure_attr_byjson(json, vi_pipe);

    ret = set_isp_ai_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_ai_attr_byjson(json, vi_pipe);

    ret = set_isp_wb_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_wb_attr_byjson(json, vi_pipe);

    ret = set_isp_awb_attr_ex_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_awb_attr_ex_byjson(json, vi_pipe);

    ret = set_isp_ccm_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_ccm_attr_byjson(json, vi_pipe);

    ret = set_isp_black_level_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }  
    ret = check_isp_black_level_attr_byjson(json, vi_pipe);

    ret = set_isp_sharpen_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_sharpen_attr_byjson(json, vi_pipe);

    ret = set_isp_gamma_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_gamma_attr_byjson(json, vi_pipe);

    ret = set_isp_drc_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_drc_attr_byjson(json, vi_pipe);

    ret = set_isp_shading_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_shading_attr_byjson(json, vi_pipe);

    ret = set_isp_dp_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_dp_attr_byjson(json, vi_pipe);

    ret = set_isp_cr_dehaze_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_cr_dehaze_attr_byjson(json, vi_pipe);

    ret = set_isp_afc_demosaic_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_afc_demosaic_attr_byjson(json, vi_pipe);

    ret = set_isp_bayershp_ca_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_bayershp_ca_attr_byjson(json, vi_pipe);

    ret = set_isp_cac_fswdr_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_cac_fswdr_attr_byjson(json, vi_pipe);

    ret = set_isp_ldci_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_ldci_attr_byjson(json, vi_pipe);

    ret = set_isp_colortone_rc_csc_clut_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret  = check_isp_colortone_rc_csc_clut_attr_byjson(json, vi_pipe);

    ret = set_isp_dngcolor_acs_expander_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_dngcolor_acs_expander_attr_byjson(json, vi_pipe);

    ret = set_isp_lblc_attr_byjson(json, vi_pipe);
    if (ret != HI_SUCCESS) {
        goto exit1;
    }
    ret = check_isp_lblc_attr_byjson(json, vi_pipe);
...
static hi_s32 sample_comm_vi_start_isp(const sample_vi_cfg *vi_cfg)
{
    hi_s8 i, j;
    hi_s32 ret;
    hi_vi_pipe vi_pipe;
...
static hi_void sample_comm_vi_stop_isp(const sample_vi_cfg *vi_cfg)
{
    hi_u32     i;
    hi_bool    start_pipe;
    hi_vi_pipe vi_pipe;
                                                          ...
                                                          sample_vi_user_frame_info *user_frame_info, hi_s32 blk_cnt)
{
    ...
    ret = sample_comm_vi_get_fpn_frame_info(vi_pipe, HI_PIXEL_FORMAT_RGB_BAYER_12BPP,
...
static hi_void *sample_common_vi_send_pipe_frame_proc(hi_void *param)
{
    hi_s32 ret;
    hi_u32 frame_cnt, send_cnt;
    const hi_video_frame_info *frame_info[HI_VI_MAX_WDR_FRAME_NUM] = {HI_NULL};
    sample_vi_send_frame_info *vi_send_frame_info = (sample_vi_send_frame_info *)param;
    const hi_s32 milli_sec = -1; /* milli_sec: -1 */
    const hi_u32 frame_num = 1;

    frame_cnt = vi_send_frame_info->frame_cnt;
    ret = hi_mpi_vi_set_pipe_frame_source(vi_send_frame_info->vi_pipe, HI_VI_PIPE_FRAME_SOURCE_USER);
    if (ret != HI_SUCCESS) {
    ...
    while (g_send_pipe_pthread) {
        if (send_cnt < frame_cnt) {
            ...
            ret = hi_mpi_vi_send_pipe_raw(vi_send_frame_info->vi_pipe, frame_info, frame_num, milli_sec);
            if (ret != HI_SUCCESS) {
    ...
    ret = hi_mpi_vi_set_pipe_frame_source(vi_send_frame_info->vi_pipe, HI_VI_PIPE_FRAME_SOURCE_FE);
    if (ret != HI_SUCCESS) {
        printf("vi set pipe frame source failed!\n");
    }
    ...
    hi_isp_fpn_calibrate_attr *calibrate_attr, hi_s32 calib_cnt)
{
    ...
    ret = pthread_create(&thread_id, HI_NULL, sample_common_vi_send_pipe_frame_proc, (hi_void *)&vi_send_frame_info);
    if (ret != HI_SUCCESS) {
...
hi_s32 sample_comm_vi_fpn_calibrate(hi_vi_pipe vi_pipe, sample_vi_fpn_calibration_cfg *calibration_cfg)
{
    ...
    // FILE* fp = fopen("vio_fpn_16.raw", "wb");
    // // for(int i = 0;i<FPN_CALIB_TIMES+1;i++)
    // // {
    //     fwrite(user_frame_info[0].frame_info.video_frame.virt_addr, user_frame_info->frame_info.video_frame.width*user_frame_info->frame_info.video_frame.height*1.5, 1, fp);
    // //     printf("%d\n", i);
    // // }
    // printf("format = %d\n",user_frame_info->frame_info.video_frame.pixel_format);

    // fclose(fp);

    // printf("before calibrate ");
...
hi_s32 sample_comm_vi_enable_fpn_correction(hi_vi_pipe vi_pipe, sample_vi_fpn_correction_cfg *correction_cfg)
{
    ...
    correction_attr.aibnr_mode = HI_TRUE;
...
static hi_s32 sample_comm_vi_read_user_frame_file(hi_vi_pipe vi_pipe, sample_vi_user_frame_info *user_frame_info)
{
    hi_s32 ret;
    FILE *pfd = HI_NULL;
    const hi_char *frame_file = "./output.yuv";
    hi_size frame_size = {WIDTH_3840, 1080};
