...
static hi_isp_pub_attr g_isp_pub_attr_isr2006_mipi_1936_1280_30fps = {
    {0, OB_HEIGHT_ISR2006, ISR2006_WIDTH, ISR2006_HEIGHT},
    {ISR2006_WIDTH, ISR2006_HEIGHT},
    30,
    HI_ISP_BAYER_BGGR,
    HI_WDR_MODE_NONE,
    0,
    ...
    {
        0,
        {0, 0, ISR2006_WIDTH, ISR2006_HEIGHT},
    },
};


static hi_isp_pub_attr g_isp_pub_attr_isr2006_mipi_1936_1280_25fps = {
    {0, OB_HEIGHT_ISR2006, ISR2006_WIDTH, ISR2006_HEIGHT},
    {ISR2006_WIDTH, ISR2006_HEIGHT},
...
static hi_isp_pub_attr g_isp_pub_attr_isr2006_mipi_968_640_25fps = {
    {0, OB_HEIGHT_ISR2006, ISR2006_968P_WIDTH, ISR2006_968P_HEIGHT},
    {ISR2006_968P_WIDTH, ISR2006_968P_HEIGHT},
    25,
    HI_ISP_BAYER_BGGR,
    HI_WDR_MODE_NONE,
    0,
    ...
    {
        0,
        {0, 0, ISR2006_968P_WIDTH, ISR2006_968P_HEIGHT},
    },
};


static hi_isp_pub_attr g_isp_pub_attr_isr2006_mipi_1920_1080_30fps = {
    {0, OB_HEIGHT_ISR2006, ISR2006_1080P_WIDTH, ISR2006_1080P_HEIGHT},
    {ISR2006_1080P_WIDTH, ISR2006_1080P_HEIGHT},
    30,
    HI_ISP_BAYER_BGGR,
    HI_WDR_MODE_NONE,
    0,
    ...
    {
        0,
        {0, 0, ISR2006_1080P_WIDTH, ISR2006_1080P_HEIGHT},
    },
};


#if VI_CROP_IS_ENANLE
static ot_isp_pub_attr g_isp_pub_attr_isr2006_mipi_crop_30fps = {
    {0, OB_HEIGHT_ISR2006, ISR2006_CROP_WIDTH, ISR2006_CROP_HEIGHT},
    {ISR2006_CROP_WIDTH, ISR2006_CROP_HEIGHT},
    25,
    HI_ISP_BAYER_BGGR,// 根据sensor手册
    HI_WDR_MODE_NONE,
    0,
    0,
    0,
    {
        HI_TRUE,
        {0, 0, ISR2006_CROP_WIDTH, ISR2006_CROP_HEIGHT},
    },
};
#endif
    ...
    switch (sns_type) {
        ...
        case ISR2006_MIPI_1936_1280_30FPS_12BIT:
         ...
         (td_void)memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_isr2006_mipi_crop_30fps, sizeof(ot_isp_pub_attr));
        #else
            (td_void)memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_isr2006_mipi_1936_1280_30fps, sizeof(ot_isp_pub_attr));
        #endif
            break;
        case ISR2006_MIPI_1936_1280_25FPS_12BIT:
         ...
         (td_void)memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_isr2006_mipi_crop_30fps, sizeof(ot_isp_pub_attr));
                pub_attr->frame_rate = 25;
        #else
            (td_void)memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_isr2006_mipi_1936_1280_25fps, sizeof(ot_isp_pub_attr));
        #endif
            break;
        case ISR2006_MIPI_968_640_25FPS_12BIT:
            (hi_void)memcpy_s(pub_attr, sizeof(hi_isp_pub_attr),
                &g_isp_pub_attr_isr2006_mipi_968_640_25fps, sizeof(hi_isp_pub_attr));
            break;
        case ISR2006_MIPI_1920_1080_30FPS_14BIT:
            (hi_void)memcpy_s(pub_attr, sizeof(hi_isp_pub_attr),
                &g_isp_pub_attr_isr2006_mipi_1920_1080_30fps, sizeof(hi_isp_pub_attr));
            break;
...
hi_isp_sns_obj *sample_comm_isp_get_sns_obj(sample_sns_type sns_type)
{
    switch (sns_type) {
        ...
        case ISR2006_MIPI_1920_1080_30FPS_14BIT:
        case ISR2006_MIPI_968_640_25FPS_12BIT:
            return &g_sns_isr2006_obj;
        // case ISR2006_MIPI_1936_1280_25FPS_12BIT:
        //     return &g_sns_isr2006_25fps_obj;
        default:
            return HI_NULL;
    }
}
