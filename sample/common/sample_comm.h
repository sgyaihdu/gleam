...
typedef enum {
    ...
    ISR2006_MIPI_1936_1280_30FPS_12BIT,
    ISR2006_MIPI_1936_1280_25FPS_12BIT,
    ISR2006_MIPI_1920_1080_30FPS_14BIT,
    ISR2006_MIPI_968_640_25FPS_12BIT,
    SAMPLE_VI_MODE_BT1120_1080P_16BIT,
    SNS_TYPE_BUTT,
} sample_sns_type;
...
typedef struct {
    ...
    hi_compress_mode compress_mode;
    hi_vo_layer_hsharpen_param vo_sharpen;//图层锐化参数。 用于控制图层的锐化程度。
    hi_bool hor_split_en;//水平分割使能标志。
...
typedef struct {
    hi_u8 reg_addr_high;
    hi_u8 reg_addr_low;
    hi_bool delay_en;//如果该值为true,则需要写后延时100ms
    hi_u8 reg_value;
}mipi_tx_i2c_cmd_info;
...
typedef struct {
    ...
    /*for i2c cmd*/
    hi_bool i2c_cmd_en;//是否使用i2c配置oled
    hi_u8 oled_num;//oled个数
    hi_u32 i2c_cmd_count[2];//i2c 命令个数
    hi_u8 i2c_bus[2];//i2c 总线地址
    hi_u8 i2c_addr[2];//i2c 设备地址 不含读写位
    hi_u8 addr_len;
    hi_u8 data_len;
    //hi_s32 i2c_fd;//打开的i2c设备的文件描述符
    mipi_tx_i2c_cmd_info* i2c_cmd_info[2];//i2c 命令

    hi_bool i2c_lt9211_enable;//是否使用i2c配置lt9211
    hi_u8 i2c_lt9211_bus;//i2c 总线地址
    hi_u8 i2c_lt9211_addr;//i2c 设备地址 不含读写位
...
hi_s32 sample_comm_vo_bind_venc(hi_vo_layer vo_layer, hi_vo_chn vo_chn, hi_venc_chn venc_chn);
hi_s32 sample_comm_vo_un_bind_venc(hi_vo_layer vo_layer, hi_vo_chn vo_chn, hi_venc_chn venc_chn);
...
hi_s32 sample_comm_vo_bt1120_i2c_init(const sample_mipi_tx_config *tx_config);
...
#define ISR2006_968P_WIDTH            968
#define ISR2006_968P_HEIGHT           640

#define ISR2006_1080P_WIDTH       1920
#define ISR2006_1080P_HEIGHT      1080

#define OB_HEIGHT_ISR2006 0

#define ZLMEDIAKIT_IS_INIT 0

#define VI_CROP_IS_ENANLE 1

#if VI_CROP_IS_ENANLE



    #define ISR2006_CROP_X 328
    #define ISR2006_CROP_Y 128
    #define ISR2006_CROP_WIDTH 1280
    #define ISR2006_CROP_HEIGHT 1024
    // #define ISR2006_CROP_X 0
    // #define ISR2006_CROP_Y 0
    // #define ISR2006_CROP_WIDTH 1920
    // #define ISR2006_CROP_HEIGHT 1080

#endif
#define RTSP_FF_ENABLE 0

#if RTSP_FF_ENABLE
    #define RTSP_URL "rtsp://192.168.35.88:9554/stream0"
#endif

#define SAVE_STREAM_TO_FILE_H265 1

#define FPN_ENABLE 0

#define RTSP_OWN_ENABLE 1

#define SENSOR_TYPE SENSOR0_TYPE

#define ISR2006_IS_MONO 1

#define USER_PIC_3840_1080 0


#define ISR2006_10BIT_ENABLE 0


#define DIS_ENABLE 1

#define AIBNR_ENABLE 1
