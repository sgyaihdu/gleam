...
static sample_vo_cfg g_vo_cfg = {
    ...
    .vo_mode = VO_MODE_1MUX,
    /* for user sync */
        .sync_info = {0, 0, 1, 1080, (8+4), 8, 3840, (72+32), 56, 1, 540, 9, 7, 32, 4, 0, 0, 0},
        //
      //.sync_info = {0, 1, 1, 1920, 12, 15, 1200, 104, 60, 1, 540, 9, 7, 24, 2, 0, 0, 0},
        .user_sync = {
            ...
            .auto_user_sync_info.pixel_clk = 132000000*2,
        },
        .dev_frame_rate = 30,//设备帧率 60
};
