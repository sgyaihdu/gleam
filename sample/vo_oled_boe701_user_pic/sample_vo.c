...
#define I2C_CMD_COUNT_1080P 33

#define I2C_BUS_NUM 5
#define I2C_DEV_ADDR ((0x98)>>1)
...
static mipi_tx_i2c_cmd_info g_i2c_cmd_info_boe701_1080p60[I2C_CMD_COUNT_1080P] = {
//高位地址 低位地址 延迟指示 寄存器值  如果2和3 同时是REG_NULL表示写0 如果只有2是REG_NULL表示写后延迟100ms
	...
	{0x11, 0x00, 0x00, 0x00}, //Sleep-out 0x11
	{0x29, 0x00, 0x00, 0x00}, //Display-On 0x29
...
/* for device */
        ...
        .vo_layer = SAMPLE_VO_LAYER_VHD0,
        .vo_intf_type = HI_VO_INTF_MIPI,
        .intf_sync = HI_VO_OUT_1080P60,//输出时序
        .pic_size = PIC_1080P,
        .bg_color = COLOR_RGB_BLACK,//背景颜色
/* for layer */
        .pix_format = HI_PIXEL_FORMAT_YVU_SEMIPLANAR_420,
        .disp_rect = {0, 0, 1920, 1080},//显示的区域
        .image_size = {1936, 1280},//输入的图像大小
...
/* for channel */
        .vo_mode = VO_MODE_1MUX,
/* for user sync */
        .sync_info = {0, 0, 1, 1080, 8, 8, 1920, 72, 56, 1, 540, 9, 7, 32, 4, 0, 0, 0},
        //
      //.sync_info = {0, 1, 1, 1920, 12, 15, 1200, 104, 60, 1, 540, 9, 7, 24, 2, 0, 0, 0},
        .user_sync = {
            .manual_user_sync_info.user_sync_attr = {
    ...
    .tx_config = {
        /* for combo dev config */
        .intf_sync = HI_MIPI_TX_OUT_1080P60,
