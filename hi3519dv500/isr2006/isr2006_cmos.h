...
// #define ISR2006_VMAX_30FPS_LINEAR    (( 2379 + ISR2006_INCREASE_LINES )*2)  /*高度*/
#define ISR2006_VMAX_30FPS_LINEAR    (( 1588 ))  /*高度*/

// #define ISR2006_VMAX_25FPS_LINEAR    (( 5279 + ISR2006_INCREASE_LINES ))  /*高度*/
#define ISR2006_VMAX_25FPS_LINEAR    (( 1280))  /*高度*/

#define ISR2006_VMAX_60FPS_LINEAR    (( 3175 ))  /*高度*/

//#define ISR2006_VMAX_30FPS_LINEAR    (( 1588 ))  /*高度*/

// #define ISR2006_VMAX_25FPS_LINEAR    (( 10580 + ISR2006_INCREASE_LINES ))  /*高度*/

typedef enum {
    ISR2006_SENSOR_1936_1280_30FPS_12BIT_LINEAR_MODE = 0,
    ISR2006_SENSOR_1936_1280_25FPS_12BIT_LINEAR_MODE,
    ISR2006_SENSOR_1936_1280_60FPS_12BIT_LINEAR_MODE,
    ISR2006_SENSOR_1920_1080_30FPS_14BIT_LINEAR_MODE,
    ISR2006_SENSOR_1920_1080_120FPS_10BIT_LINEAR_MODE,
    ISR2006_MODE_BUTT
} isr2006_res_mode;
...
// td_s32 isr2006_read_register(ot_vi_pipe vi_pipe, td_u32 addr, td_u32 *data);
